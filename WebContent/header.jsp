    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="rookiesViewProduct.jsp"><span class="glyphicon glyphicon-home">&nbsp;</span>"CART"</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="rookiesViewProduct.jsp">Products</a></li>
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Category <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="rookiesViewProduct.jsp?type=mobile">Mobiles</a></li>
                            <li><a href="rookiesViewProduct.jsp?type=tv">TVs</a></li>
                            <li><a href="rookiesViewProduct.jsp?type=laptop">Laptops</a></li>
                            <li><a href="rookiesViewProduct.jsp?type=camera">Camera</a></li>
                            <li><a href="rookiesViewProduct.jsp?type=speaker">Speakers</a></li>
                            <li><a href="rookiesViewProduct.jsp?type=tablet">Tablets</a></li>
                        </ul>
                    </li>
                    <li><a href="rookiesStock.jsp">Stock</a></li>
